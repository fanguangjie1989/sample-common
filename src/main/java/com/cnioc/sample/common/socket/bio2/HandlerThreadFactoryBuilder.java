 ...
 */
public class HandlerThreadFactoryBuilder implements ThreadFactory {
	/**
	 * 线程池编号
	 */
	...
	public HandlerThreadFactoryBuilder(ThreadGroup group, String prefix) {
		if (group == null) {
	...
	public HandlerThreadFactoryBuilder(String prefix){
		this(null, prefix);
	}
	
	public HandlerThreadFactoryBuilder() {
		this(null, null);
	}
